...
image_path = r"D:\capstone\24_12_11\processed_result.png"  # Replace with your file path
...
np.save(r"D:\capstone\24_12_11\result_grid_min.npy", result_grid)
print("Resulting grid saved as 'result_grid.npy'.")

# Save the resulting grid as a CSV file
csv_output_path = r"D:\capstone\24_12_11\result_grid_test_size_min.csv"
